...
while { player distance _veh < 10 and (player distance _startPos) < 0.4 and alive player and alive _truck and alive _veh and vehicle player == player and speed _veh <= 3 and speed _truck <=3 and not _repairFinished and WMT_mutexAction and player distance _truck <= DISTANCE_TO_REPAIRVEHICLE } do {
